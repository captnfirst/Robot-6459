...
public class Robot extends TimedRobot {
  ...
  int desiredPos = 0; // -1 = human / 0 = start / 1 = 1 lvl / 2 = 2 lvl / 3 = cube ground
  ...
  public void teleopPeriodic() {
    ...
    if (desiredPos == -1) { // human player
      ...
      kDriveSpeed = 0.78;
      kRotationSpeed = 0.54;
    } else if (desiredPos == 2) { // 2 lvl
      kDriveSpeed = 0.55;
      kRotationSpeed = 0.53;
    } else if (desiredPos == 3) { // cube ground
      kDriveSpeed = 0.5;
      kRotationSpeed = 0.53;
    }
    ...
    if (yardimciJoystick.getRawButton(5)) {
      ...
      if (desiredPos == -1) {
        ...
        m_robotContainer.m_intake.setIntakeSolenoid(Value.kReverse);
      } else if (desiredPos == 2 && gamePiece == 1) {
      ...
      } else if (desiredPos == 2 && gamePiece == -1) { // cube
        m_robotContainer.m_intake.setIntake(-0.7);
      } else if (desiredPos == 1 && gamePiece == 1) { // cone
        m_robotContainer.m_intake.setIntakeSolenoid(Value.kReverse);
      } else if (desiredPos == 1 && gamePiece == -1) { // cube
        ...
        m_robotContainer.m_intake.setIntake(0.15);
      }
    ...
    if (backlashTimer.get() > 2) {
      if (desiredPos == -1) {
        ...
        if (m_robotContainer.m_arm.getArmPos() > 20) {
          m_robotContainer.m_head.setHead(true, 6000 + cubedOffset);
        }
        m_robotContainer.m_turret.lockOnTarget(false, false);
